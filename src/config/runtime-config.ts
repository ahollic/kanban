...
const AUTO_SELECT_AGENT_PRIORITY: readonly RuntimeAgentId[] = ["claude", "codex", "droid", "kimi"];
...
function normalizeAgentId(agentId: RuntimeAgentId | string | null | undefined): RuntimeAgentId {
	if (typeof agentId === "string" && isRuntimeAgentLaunchSupported(agentId as RuntimeAgentId)) {
		return agentId as RuntimeAgentId;
	}
